...
SECRET_KEY = 'django-insecure-(ruzl=x6!i@m-hr%x^q7qy6ssv&i#xj*q54#q@%v-=ens1os72'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["localhost","127.0.0.1","devsearch2.herokuapp.com"]
...
EMAIL_PORT=587
EMAIL_USE_TLS=True
EMAIL_HOST_USER="devsearchx1@gmail.com"
EMAIL_HOST_PASSWORD="pkhrqokyfyfzntjs"
